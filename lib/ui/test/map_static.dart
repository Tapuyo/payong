...
class MapStaticTesting extends StatefulWidget {
  const MapStaticTesting({super.key});

  @override
  State<MapStaticTesting> createState() => _MapStaticTestingState();
}

class _MapStaticTestingState extends State<MapStaticTesting> {
  final retroMapStyle = [
    const MapStyle(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: StaticMap(
          googleApiKey: "AIzaSyCSrn2Mh8tdIUp-3cnlgZYmr6KdEaofm5I",
          width: MediaQuery.of(context).size.width,
          height: MediaQuery.of(context).size.height,
