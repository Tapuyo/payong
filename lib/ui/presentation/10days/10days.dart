...
class Daily10Widget extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final DailyModel? dailyDetails = context.select((DailyProvider p) => p.dailyDetails);
    useEffect(() {
                  ...
                  children: [
                    ...
                    Align(
                        ...
                        child: Padding(
                            ...
                            child: Icon(
                              double.parse(dailyDetails != null ? dailyDetails.rainFall:'0') < 10
                                  ? FontAwesomeIcons.cloudRain
                                  : FontAwesomeIcons.cloudSun,
                              size: 55,
                              color: double.parse(dailyDetails != null ? dailyDetails.rainFall:'0') < 10
                                  ? Colors.grey
                                  : Colors.amber,
                            ))),
                    Align(
