...
class AgriForecastSoilMoistWidget extends HookWidget {
    ...
    return dailyAgriDetails != null
        ? Padding(
            ...
            child: SizedBox(
              ...
              //               decoration: BoxDecoration(
              //                 color: Color.fromRGBO(165, 70, 238, 1),
  ...
  Widget SoilMoisture(BuildContext context){
    return Column(children: [
      returnMoisture(context, 'WET','Quezon, Romblon, southern portion ofPalawan, most of Bicol Region, Capiz, most of Eastern Visayas, and Surigao del Norte','assets/soilmoistnormal.jpg' ),
      returnMoisture(context, 'MOIST','Calayan, Aparri, Basco, Bataan, Bulacan, Tarlac, Laguna, Rizal, central portion of Palawan, CamarinesSur, Albay, Negros Oriental, Bohol, northern portion of Zamboanga Peninsula Tagum, and Agusan del Norte','assets/soilmoistwet.jpg' ),
       returnMoisture(context, 'DRY','Quezon, Romblon, southern portion ofPalawan, most of Bicol Region, Capiz','assets/soilmoistnormal.jpg' ),
    ],);
  }

  Widget returnMoisture(BuildContext context, String title, content, image){
    return Padding(
                      padding: const EdgeInsets.fromLTRB(0, 10, 0, 10),
                  child: Container(
                      decoration: BoxDecoration(
