...
class AgriForecastLeafWidget extends HookWidget {
  const AgriForecastLeafWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final List<AgriForecastLeafWetnessModel>? dailyAgriDetails =
        context.select((AgriProvider p) => p.agriForecastLeafWetness);
    useEffect(() {
      Future.microtask(() async {
        await AgriServices.getForecastLeafwetness(context);
      });
      return;
    }, []);
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  //               width: 50,
                  //               height: 50,
                  //               child: Image.asset('assets/leafwetness.png'))),
                  //     ],
                  //   ),
                  // ));
                  return Padding(
