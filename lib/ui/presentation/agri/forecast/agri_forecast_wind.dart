...
class AgriForecastWindWidget extends HookWidget {
  const AgriForecastWindWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final List<AgriForecastWindModel>? dailyAgriDetails =
        context.select((AgriProvider p) => p.agriForecastWind);
    useEffect(() {
      Future.microtask(() async {
        await AgriServices.getForecastWind(context);
      });
      return;
    }, []);
                        ...
                        children: [
                          ...
                          Row(
                              ...
                              children: [
                                ...
                                if(dailyAgriDetails[index].windConditionIcon != '')
                                Expanded(
                                  child: SizedBox(
                                      width: 100,
                                      height: 100,
                                      child: Image.network(dailyAgriDetails[index].windConditionIcon)),
                                )
                              ]),
                        ],
                      ),
